...
Выбор шаблона зависит от вида изделия, указанного при создании модели. Например, если выбран вид изделия **Трубопроводная арматура**, будут доступны пять отраслевых шаблонов, а если **Пневмопривод** – шаблон для пневмопривода.

Подробное описания шаблонов по видам изделий – в подразделах [Трубопроводная арматура](templates/pipeline_valves/index.md) и [Пневмоприводы](templates/pneumatic_drives.md).
