<div class="breadcrumbs">
  <a href="/ru/">Главная</a><span class="breadcrumbs__sep"> / </span><span class="breadcrumbs__current">Описание шаблонов</span>
</div>
...
- [Паспорт электропривода (РФ)](templates/electric_drives.md);
- [Паспорт изделия (РФ)](templates/other_equipment.md).

{% note info "" %}

Выбор шаблона зависит от вида изделия, указанного при создании модели. Если выбран вид изделия **Трубопроводная арматура** – доступны пять отраслевых шаблонов, если **Пневмопривод** или **Электропривод** – шаблон для соответствующего привода, если **Другое оборудование** – общий шаблон «Паспорт изделия (РФ)».

Подробное описание шаблонов по видам изделий – в подразделах [Трубопроводная арматура](templates/pipeline_valves/index.md), [Пневмоприводы](templates/pneumatic_drives.md), [Электроприводы](templates/electric_drives.md) и [Другое оборудование](templates/other_equipment.md).
...
Шаблон состоит из разделов  (пример для трубопроводной арматуры). Обязательные поля отмечены звёздочкой – без них шаблон не сохранится. Разделы, не нужные для конкретного изделия, отключаются переключателем – например, раздел **Привод** отключают, если способ управления ручной.
