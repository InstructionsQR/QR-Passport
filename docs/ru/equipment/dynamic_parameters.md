...
- _Допустимые символы:_ буквы, цифры, пробел и запятая. Например: «**Серийный номер**», «**Серийный, заводской номер**».
- _Недопустимые символы:_ точки, знак №, нижнее подчеркивание и другие специальные символы. Например: «**Серийный №**», «**Серийный_номер**», «**Зав. номер**».
