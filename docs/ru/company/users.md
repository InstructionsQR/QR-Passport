...
* _активный_ – статус активности учетной записи (справа доступна фильтрация по статусу активности).
...
* _права доступа_ – настройка прав доступа и отметка о статусе активности учетной записи (снятие отметки _Активный_ является альтернативой удалению учетной записи);
...
3. В блоке **Права доступа** двойным щелчком мыши выберите доступ этого пользователя к функционалу QR-Passport
