...
* **Модель оборудования** –  это шаблон для группы однотипных изделий. Он содержит общие характеристики, документацию и динамические параметры для всех относящихся к нему изделий.
...
* **Динамические параметры** – настраиваемые характеристики, которые добавляются к модели и заполняются для каждого изделия отдельно. Позволяют учитывать индивидуальные особенности разных единиц оборудования, такие как: серийный номер, дата изготовления и другие.

* **Зарегистрировать изделие** – это процесс внесения в систему данных о конкретной единице продукции, который включает заполнение динамических параметров. В результате изделие получает собственный QR-код и становится полноценным объектом учета в системе с возможностью отслеживания его характеристик, документации и получения технической поддержки.
...
3. Введите название группы `Пневмоприводы` – так назовем родительскую группу, так как это название оборудования и его можно взять за основу структуры.
...
Чтобы конкретизировать, что модель относится не только к группе _пневмоприводы_, но и к подгруппе _серия VT_, необходимо создать внутри родительской группы – дочернюю. 
