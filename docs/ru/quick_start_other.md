<div class="breadcrumbs">
  <a href="/ru/">Главная</a><span class="breadcrumbs__sep"> / </span><span class="breadcrumbs__current">Быстрый старт</span>
</div>
...
**Результат:** изделия _РД-001-2026 – РД-005-2026_ зарегистрированы, паспорта и QR-коды скачаны. Задача выполнена.
...
2. _Удаление шаблона_
   ...
   - Перейдите в модель **Редуктор РД-100**.
