# Тикеты
<!--Подраздел **Тикеты** предназначен для работы с обращениями пользователей, позволяет отслеживать статусы заявок и просматривать всю историю сообщений.
...
* _DOING_ – тикет взят в работу, над обращением ведется активная деятельность;
...
* _DONE_ – тикет закрыт, вопрос решен.
