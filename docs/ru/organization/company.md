<div class="breadcrumbs">
  <a href="/ru/">Главная</a><span class="breadcrumbs__sep"> / </span><span class="breadcrumbs__current">Компания</span>
</div>
...
Раздел «Компания» доступен только пользователям с уровнем доступа **Администратор**.
