...
Для быстрого поиска используйте поле «Поиск по имени или email». Кнопка (**⋯**) напротив пользователя открывает меню управления его доступом. Внизу таблицы настраивается количество строк на странице и перелистывание.

## Вкладка «Приглашения» – приглашение пользователя
...
3. В блоке **«Права доступа»** назначьте новому пользователю роль:
   ...
   - **«Без роли»** – только индивидуальные разрешения.
...
Во вкладке «Приглашения» отображаются все отправленные приглашения – по ним можно управлять (повторить или отозвать).
...
- **Системные роли** – предустановленные роли с фиксированным набором разрешений:
  ...
  Системные роли нельзя редактировать или удалить – можно только посмотреть состав прав (кнопка с глазами).
...
Историю действий видите только вы – администраторы вашей организации. Команда QR-Passport не имеет доступа к этим данным. А если захочется ограничить доступ внутри компании – это тоже предусмотрено: журнал не отображается у сотрудников, чьим ролям не добавлено соответствующее разрешение.
