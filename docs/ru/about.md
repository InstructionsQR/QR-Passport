...
Если вы впервые работаете в QR-Passport, начните с примера под ваш вид изделия. Последующие разделы содержат детальное описание функционала для самостоятельного изучения.
