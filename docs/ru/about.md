...
Интерфейс системы будет выглядеть по-разному в зависимости от прав доступа.
...
2. Последующие разделы содержат детальное описание функционала для самостоятельного изучения.
